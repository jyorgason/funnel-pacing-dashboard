...
/* ── Generated by claude-refresh-bot on 2026-06-04 ──────────────────────────
   ...
   May baseline aligned to DG sheet: SAO=2,181 / MQL=8,561 / biz_days=20
   June total_bdays=22
...
window.REPORT = {
  ...
  metrics: [
    ...
    },
    {
      ...
      target: 7656, forecast: 9417, mom: 10.0, yoy: 5.3,
      overridden: false,
      children: [
        { key: "mql_ta",    label: "TA MQL",    kind: "count", target: 3694, forecast: 5436, mom: 10.0, yoy: 23.6, overridden: false },
        { key: "mql_micro", label: "Micro MQL", kind: "count", target: 3962, forecast: 3981, mom: 10.0, yoy: -12.4, overridden: false },
      ],
    },
    {
      key: "mql_sao", label: "MQL → SAO", kind: "rate", role: "conversion",
      target: 35.86, forecast: 25.48, mom: 0.0, yoy: -24.7,
      overridden: false,
    },
    {
      key: "sao", label: "Total SAOs", kind: "count", role: "volume",
      target: 3030, forecast: 2399, mom: 10.0, yoy: -20.7,
      overridden: false,
      children: [
        { key: "sao_ta",    label: "TA SAO",    kind: "count", target: 1689, forecast: 1432, mom: 10.0, yoy: -23.1, overridden: false },
        { key: "sao_micro", label: "Micro SAO", kind: "count", target: 1341, forecast: 967,  mom: 10.0, yoy: -16.9, overridden: false },
      ],
    },
  ],
  primaryKey: "sao",
