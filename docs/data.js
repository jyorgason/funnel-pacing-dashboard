...
/* ── Generated by claude-refresh-bot on 2026-06-04 ──────────────────────────
   ...
   May baseline: SAO=2,163 / MQL=8,513 / biz_days=20
   June total_bdays=22
...
window.REPORT = {
  ...
  metrics: [
    ...
    },
    {
      ...
      target: 7656, forecast: 9364, mom: 10.0, yoy: 4.7,
      overridden: false,
      children: [
        { key: "mql_ta",    label: "TA MQL",    kind: "count", target: 3694, forecast: 5405, mom: 10.0, yoy: 22.9, overridden: false },
        { key: "mql_micro", label: "Micro MQL", kind: "count", target: 3962, forecast: 3959, mom: 10.0, yoy: -12.9, overridden: false },
      ],
    },
    {
      key: "mql_sao", label: "MQL → SAO", kind: "rate", role: "conversion",
      target: 35.86, forecast: 25.41, mom: 0.0, yoy: -24.9,
      overridden: false,
    },
    {
      key: "sao", label: "Total SAOs", kind: "count", role: "volume",
      target: 3030, forecast: 2357, mom: 9.0, yoy: -22.1,
      overridden: false,
      children: [
        { key: "sao_ta",    label: "TA SAO",    kind: "count", target: 1689, forecast: 1407, mom: 10.0, yoy: -24.4, overridden: false },
        { key: "sao_micro", label: "Micro SAO", kind: "count", target: 1341, forecast: 950,  mom: 7.5,  yoy: -18.3, overridden: false },
      ],
    },
  ],
  primaryKey: "sao",
