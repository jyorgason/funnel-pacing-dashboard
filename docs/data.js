...
window.REPORT = {
  ...
  metrics: [
    { key: "visits", label: "Marketable Visits", kind: "count", role: "volume",
      target: 0, forecast: 485736, prior_month: 506503, prior_year: 451847, overridden: false },
    { key: "cvr", label: "Website CVR", kind: "rate", role: "conversion",
      target: 0, forecast: 3.05, prior_month: 5.45, prior_year: 4.86, overridden: false },
    { key: "mql", label: "Total MQLs", kind: "count", role: "volume",
      target: 0, forecast: 9365, prior_month: 8514, prior_year: 8943, overridden: false,
      children: [
        { key: "mql_ta", label: "TA MQL", kind: "count",
          target: 0, forecast: 5409, prior_month: 4917, prior_year: 4398, overridden: false },
        { key: "mql_micro", label: "Micro MQL", kind: "count",
          target: 0, forecast: 3956, prior_month: 3597, prior_year: 4545, overridden: false },
      ] },
    { key: "mql_sao", label: "MQL \u2192 SAO", kind: "rate", role: "conversion",
      target: 0, forecast: 25.42, prior_month: 25.42, prior_year: 33.83, overridden: false },
    { key: "sao", label: "Total SAOs", kind: "count", role: "volume",
      target: 0, forecast: 2380, prior_month: 2164, prior_year: 3025, overridden: false,
      children: [
        { key: "sao_ta", label: "TA SAO", kind: "count",
          target: 0, forecast: 1408, prior_month: 1280, prior_year: 1862, overridden: false },
        { key: "sao_micro", label: "Micro SAO", kind: "count",
          target: 0, forecast: 972, prior_month: 884, prior_year: 1163, overridden: false },
      ] },
  ],
};
